const registerSplitPoly = (L) => {
  ...
  L.Split.PolyVerticesEdit = L.Handler.extend({
    ...
    initialize: function (poly, latlngs, options) {
      ...
      const [toolbar] = document.getElementsByClassName('leaflet-draw')
      if (toolbar) {
    ...
    _contextMenuDisabled(marker) {
      ...
      marker.options.contextmenuItems[2].disabled =
        delDisabled || isFirstOrScendOrLast
